...
if [ ! -f "$SampleDir"/seg_allen_space/"$SampleFolder"_vox_seg_ilastik_2_gubra_space.nii.gz ] ; then
...
echo ""$SampleDir"/seg_allen_space/"$SampleFolder"_vox_seg_ilastik_2_gubra_space.nii.gz exists, skipping"
fi
