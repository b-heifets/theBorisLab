...
cd "$Dir"
#===============================================================
ABA_histo_in_tissue.sh #first determine threshold for 488 mask with ABA_488mask_merge.ijm (input: ABA_488_downsample.tif from ABA_488_ds.sh) and adjust in ABA_within_tissue.ijm ##########################################################################
#===============================================================
#Required inputs:
#reg_final/ABA_488_downsample.tif
...
#===============================================================
for dir in seg_ilastik_*; do cd "$dir" ; ABAseg_3dc_RH.sh ; done
#===============================================================
#Required inputs:
#reg_final/annotation_hemi_split_10um_clar_vox.tif
